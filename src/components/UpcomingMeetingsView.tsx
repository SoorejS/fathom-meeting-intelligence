...
export const UpcomingMeetingsView: React.FC<UpcomingMeetingsViewProps> = ({
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 bg-[#191919]">
      {/* Header Banner */}
      <div className="p-6 rounded-2xl bg-gradient-to-r from-[#252527] via-[#252527] to-[#191919] border border-[#343436] flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="grid grid-cols-1 gap-3.5">
          {upcomingMeetings.map((meeting) => {
            ...
            return (
              <div
                key={meeting.id}
                className="p-5 rounded-2xl bg-[#252527] border border-[#343436] hover:border-cyan-500/40 hover:bg-[#252527] transition-all space-y-4 group"
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2.5 bg-[#252527] border border-[#343436] px-3 py-2 rounded-xl shrink-0">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-[#343436]">
                  {/* Attendees */}
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    <div className="flex items-center gap-1.5">
                      {meeting.participants.map((p) => (
                        <div
                          key={p.id}
                          className="flex items-center gap-1 bg-[#252527] border border-[#343436] px-2 py-1 rounded-lg text-[11px] text-slate-300"
                          title={`${p.name} (${p.role})`}
                        >
                          <span
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-slate-300 hover:text-white bg-[#303033] hover:bg-[#303033] border border-[#343436] rounded-lg transition-colors cursor-pointer"
                    >
