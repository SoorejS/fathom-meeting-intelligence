...
export const GlobalSearchModal: React.FC<GlobalSearchModalProps> = ({
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Search meetings" className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-start justify-center pt-16 px-4 animate-in fade-in duration-150">
      <div
        className="w-full max-w-2xl bg-[#252527] border border-[#343436] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh] animate-in zoom-in-95 duration-150"
        onKeyDown={handleKeyDown}
      >
        {/* Search Header Bar */}
        <div className="flex items-center px-4 py-3.5 border-b border-[#343436] gap-3">
          ...
          <kbd className="text-[10px] text-slate-400 px-1.5 py-0.5 rounded bg-[#303033] border border-[#343436]">
            ESC
          </kbd>
        </div>

        {/* Filter Categories */}
        <div className="flex items-center gap-1.5 px-4 py-2 border-b border-[#343436] bg-[#191919] overflow-x-auto text-xs">
          {[
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-md transition-colors font-medium whitespace-nowrap ${
                activeCategory === cat.id
                  ...
                  : "text-slate-400 hover:text-slate-200 hover:bg-[#303033]"
              }`}
            >
              {cat.label}
            </button>
                ...
                <div
                  ...
                  className={`p-3 rounded-xl cursor-pointer transition-all flex items-start gap-3 group ${
                    isSelected
                      ...
                      : "hover:bg-[#252527] text-slate-300"
                  }`}
                >
                  <div className="p-2 rounded-lg bg-[#303033] border border-[#343436] shrink-0 mt-0.5">
                    {icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-1.5 text-[10px] text-slate-400">
                      ...
                      <span className="px-1.5 py-0.2 rounded bg-[#303033] text-slate-300 font-medium">
                        {item.category}
                      </span>
                    </div>
                  </div>
        ...
        {/* Footer info */}
        <div className="px-4 py-2 bg-[#191919] border-t border-[#343436] flex items-center justify-between text-[10px] text-slate-400">
          <div className="hidden sm:flex items-center gap-3">
            <span>
              Use <kbd className="px-1 py-0.5 bg-[#303033] rounded border border-[#343436]">↑</kbd>{" "}
              <kbd className="px-1 py-0.5 bg-[#303033] rounded border border-[#343436]">↓</kbd> to navigate
            </span>
            <span>
              <kbd className="px-1 py-0.5 bg-[#303033] rounded border border-[#343436]">ENTER</kbd> to open
            </span>
          </div>
