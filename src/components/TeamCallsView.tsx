...
export const TeamCallsView: React.FC<TeamCallsViewProps> = ({
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 bg-[#191919]">
      {/* Header Banner */}
      <div className="pb-4 border-b border-[#343436] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-64 shrink-0">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-1.5 text-xs bg-[#303033] border border-[#343436] focus:border-cyan-500 rounded-lg text-white placeholder-slate-500 focus:outline-none"
          />
        </div>
      </div>
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all whitespace-nowrap cursor-pointer ${
              selectedTeammate === "All"
                ...
                : "bg-[#252527] hover:bg-[#303033] text-slate-400 hover:text-slate-200 border border-[#343436]"
            }`}
          >
            <span>All Teammates</span>
            <span className="ml-1.5 text-[10px] font-mono px-1.5 py-0.2 rounded-full bg-[#303033] text-slate-300">
          ...
          {TEAM_MEMBERS.map((member) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] font-mono px-1.5 py-0.2 rounded-full bg-[#303033] text-slate-300">
                  {memberCount}
                </span>
              </button>
            );
      ...
      <div className="space-y-4">
        {displayedMeetings.length === 0 ? (
          <div className="p-12 rounded-2xl border border-dashed border-[#343436] bg-[#191919] text-center max-w-lg mx-auto my-8 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            {displayedMeetings.map((meeting) => {
              ...
              return (
                <div
                  key={meeting.id}
                  className="group bg-[#252527] hover:bg-[#303033] border border-[#343436] hover:border-cyan-500/40 rounded-xl overflow-hidden transition-all duration-200 flex flex-col justify-between hover:shadow-xl cursor-pointer"
                ...
                >
                  ...
                  <div className="relative aspect-video w-full overflow-hidden bg-slate-900">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#252527] via-transparent to-black/30" />
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                    ...
                    <div
                      className="pt-2 border-t border-[#343436] flex items-center justify-between text-xs"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className={`text-[10px] px-2 py-0.5 rounded font-semibold border transition-colors cursor-pointer ${
                            isTeam
                              ...
                              : "bg-[#303033] text-slate-400 border-[#343436] hover:text-slate-200"
                          }`}
                        ...
                        <button
                          ...
                          className="p-1 rounded text-slate-400 hover:text-white hover:bg-[#303033] transition-colors"
      ...
      {toastMessage && (
        <div className="fixed bottom-5 right-5 z-50 bg-[#252527] border border-cyan-500/40 text-white text-xs px-4 py-2.5 rounded-lg shadow-xl shadow-cyan-950/40 flex items-center gap-2 animate-in fade-in slide-in-from-bottom-2 duration-150">
