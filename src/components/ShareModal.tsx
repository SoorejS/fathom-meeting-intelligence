...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Share meeting" onKeyDown={(event) => { if (event.key === "Escape") onClose(); }} className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-150">
      <div className="w-full max-w-md bg-[#252527] border border-[#343436] rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-[#343436]">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="p-3 bg-[#252527] border border-[#343436] rounded-xl flex items-center gap-3">
          ...
          {/* Timestamp Toggle */}
          <label className="flex items-center justify-between p-3 rounded-xl bg-[#252527] border border-[#343436] cursor-pointer group">
            ...
            <input
              ...
              className="w-4 h-4 rounded border-[#343436] bg-[#191919] text-[#00c2ff] focus:ring-0 cursor-pointer accent-[#00c2ff]"
            />
          </label>

          {/* Access Permission Info */}
          <div className="flex items-center gap-2.5 p-2.5 bg-[#191919] rounded-xl border border-[#343436] text-xs text-slate-300">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 bg-[#191919] border border-[#343436] rounded-xl p-1.5">
              <input
                type="text"
                readOnly
        ...
        {/* Footer */}
        <div className="p-3 bg-[#191919] border-t border-[#343436] text-center">
          <p className="text-[10px] text-slate-400">
